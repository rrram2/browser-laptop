 ...
 */
const setWindowDimensions = (browserOpts, defaults, newWindowState) => {
  if (newWindowState.ui && newWindowState.ui.size) {
    browserOpts.width = firstDefinedValue(browserOpts.width, newWindowState.ui.size[0])
    browserOpts.height = firstDefinedValue(browserOpts.height, newWindowState.ui.size[1])
  }
 ...
 */
const setWindowPosition = (browserOpts, defaults, newWindowState) => {
  ...
  } else if (newWindowState.ui && newWindowState.ui.position) {
    // Position comes from window state
    browserOpts.x = firstDefinedValue(browserOpts.x, newWindowState.ui.position[0])
    browserOpts.y = firstDefinedValue(browserOpts.y, newWindowState.ui.position[1])
...
const createWindow = (state, action) => {
  ...
  browserOpts = setWindowDimensions(browserOpts, defaults, newWindowState)
  browserOpts = setWindowPosition(browserOpts, defaults, newWindowState)
  ...
  setImmediate(() => {
    ...
    if (newWindowState.ui && newWindowState.ui.isMaximized) {
      mainWindow.maximize()
    }

    if (newWindowState.ui && newWindowState.ui.isFullScreen) {
