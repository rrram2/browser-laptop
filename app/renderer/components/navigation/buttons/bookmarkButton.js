    ...
    return (
      <NormalizedButton navigationButton
        custom={[
          ...
          this.props.bookmarked && styles.bookmarkButton_bookmarked
        ]}
        l10nId={this.props.bookmarked ? 'removeBookmarkButton' : 'addBookmarkButton'}
        testId={this.props.bookmarked ? 'bookmarked' : 'notBookmarked'}
